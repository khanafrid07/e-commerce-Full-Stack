...
export default function AccessoriesCategories() {
  ...
  return (
    <section id="shop-categories" className="mb-20 scroll-mt-24 sm:px-6">
        ...
        <div className="inline-flex items-center p-1 md:p-1.5 bg-base-200/50 backdrop-blur-md rounded-full border border-base-content/10 shadow-sm max-w-[95%] overflow-x-auto no-scrollbar">
          {["all", "women", "men"].map((tab) => (
            <button
              ...
              className={`px-4 md:px-10 py-2 md:py-3 rounded-full text-[10px] md:text-sm font-semibold tracking-widest uppercase transition-all duration-300 whitespace-nowrap ${activeTab === tab
      ...
      <div>
        <NewArrivals category={"Accessories"} gender={activeTab === "all" ? null : activeTab} />
      </div>
    </section>
  );
}
