        ...
        >
          ...
          >
            ...
            <div className="relative h-80 sm:h-96 md:h-[28rem] lg:h-[32rem] flex flex-col justify-between p-6 sm:p-8 md:p-10 lg:p-12 overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-b from-red-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-5" />
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="relative z-10 inline-flex items-center gap-2 px-6 sm:px-7 py-2.5 sm:py-3 bg-white text-red-600 font-bold text-sm sm:text-base rounded-lg hover:bg-gray-100 transition-all duration-300 w-fit"
              >
                Explore Collection
                <ArrowRight size={18} />
              </motion.button>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 p-5 sm:p-6 md:p-8">
                ...
                >
                  ...
                  <div>
                    ...
                    <h4 className="text-lg sm:text-2xl md:text-3xl font-black text-rose-900 mt-1">
                      Discover <br /> Summer Styles
                    </h4>
                  </div>
                  ...
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="inline-flex items-center gap-2 px-5 sm:px-6 py-2 sm:py-2.5 bg-gradient-to-r from-rose-600 to-red-600 text-white font-bold text-sm rounded-lg hover:shadow-lg transition-all duration-300 w-fit"
                  >
                    Shop Now
                    <ArrowRight size={16} />
                  </motion.button>
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 p-5 sm:p-6 md:p-8">
                ...
                >
                  ...
                  <div>
                    <p className="text-xs sm:text-sm text-orange-600 font-medium">Men's Collection</p>
                    <h4 className="text-lg sm:text-2xl md:text-3xl font-black text-orange-900 mt-1">
                      Premium <br /> Fashion
                    </h4>
                  </div>
