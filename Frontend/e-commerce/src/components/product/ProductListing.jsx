    ...
    <div className="flex mt-4 min-h-screen bg-gray-50">
      ...
      <main className="flex-1 p-5 md:p-7">
        <div className="flex  content-center">
          ...
          {searchParams.get("search") && <p className="flex self-center mb-4 italic text-sm opacity-50">Search results for {searchParams.get("search")} {data?.allProducts?.length} found.</p>}
        </div>
