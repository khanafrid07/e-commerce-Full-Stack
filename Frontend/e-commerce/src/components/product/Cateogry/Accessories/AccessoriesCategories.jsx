  ...
  const accessories = {
    men: [
      ...
      },
      {
        ...
        image: "https://images.unsplash.com/photo-1624222247344-550fb60583e2?w=900",
        type: "belts",
    ...
    women: [
      {
        ...
        icon: <ShoppingBag className="w-4 h-4 md:w-6 md:h-6" />,
        image: "https://images.unsplash.com/photo-1584916201218-f4242ceb4809?w=900",
        type: "handbags",
      ...
      },
      {
        label: "Silk Scarves",
        icon: <Award className="w-4 h-4 md:w-6 md:h-6" />,
        image: "https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=900",
        type: "scarves",
