...
export default function FashionSection() {
 const {data, isLoading} = useGetBannerQuery({type:"category", category:"fashion"})
...
<div className="space-y-4">
          ...
          <div className="max-w-9xl mx-auto px-2 md:px-4">
            <BannerSlot placement={"home_top"} banners={data} rounded = {false}/>
          </div>
       

            <div className="max-w-9xl mx-auto px-4 md:px-6 py-8 flex gap-8 flex-col">
